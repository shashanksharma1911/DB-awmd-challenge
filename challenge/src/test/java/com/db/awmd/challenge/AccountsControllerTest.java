...
public class AccountsControllerTest {
  ...
  public void getAccount() throws Exception {
    ...
    this.mockMvc.perform(get("/v1/accounts/" + uniqueAccountId))
	  ...
	  this.accountsService.createAccount(new Account("af2", new BigDecimal("20.20")));
	  this.accountsService.createAccount(new Account("af1", new BigDecimal("10.10")));
	  
	  MoneyTransferRequest mtr = new MoneyTransferRequest(); 
	  mtr.setAccountFromId("af1"); 
	  mtr.setAccountToId("af2");
	  ...
	  this.mockMvc.perform(post("/v1/accounts/moneyTransfer").contentType(MediaType.APPLICATION_JSON)
		      .content("{\"accountFromId\":\"af1\",\"accountToId\":\"af2\",\"amount\":5.10}")).andExpect(status().isOk());
	  }
